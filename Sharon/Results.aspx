<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Results.aspx.cs" Inherits="Sharon.Results" %>
    ...
    <form id="form1" runat="server">
         ...
         <nav>
	        <div class="nav-bar resultsnav">
		                ...
		                <a href="index.aspx">
		                    <img class="logo logo-dark searchBar" alt="Sharon" src="img/logo-nav.png"/>
		                </a>
                                    ...
                                    <div class="portlet box red">
                                       <div class="portlet-title">
                                                                ...
                                                                <ul class="nav nav-tabs">
                                                                    <li id="tab_recent" runat="server">
                                                                        <a href="#portlet_tab_6" data-toggle="tab"> Recent CRQs & INCs</a>
                                                                    </li>
                                                                     <li id="tab_bcp" runat="server">
                                                                        <a href="#portlet_tab_5" data-toggle="tab"> BCP </a>
                                                                    </li>
                                                                     <li id="tab_blackoutinfo" runat="server">
                                                                        <a href="#portlet_tab_4" data-toggle="tab"> Blackout </a>
                                                                    </li>
                                                                    <li id="tab_relatedassets" runat="server">
                                                                        <a href="#portlet_tab_3" data-toggle="tab"> Related Assets </a>
                                                                    </li>
                                       ...
                                       <div class="portlet-body">
                                                                <div class="tab-content">
                                                                    ...
                                                                    <div class="tab-pane" id="portlet_tab_2">
                                                                        ...
                                                                        <asp:HyperLink NavigateUrl="mailto:kevin.olanday@macquarie.com" runat="server" id="peopleEmail"  Text="Send Email" />
                                                                    </div>
                                                                     <div class="tab-pane" id="portlet_tab_3">
                                                                        <asp:PlaceHolder ID = "table_relatedassets" runat="server" />
                                                                    </div>
                                                                    <div class="tab-pane" id="portlet_tab_4">
                                                                        <asp:PlaceHolder ID = "table_blackoutinfo" runat="server" />
                                                                    </div>
                                                                    <div class="tab-pane" id="portlet_tab_5">
                                                                        <asp:PlaceHolder ID = "table_bcp" runat="server" />
                                                                    </div>
                                                                     <div class="tab-pane" id="portlet_tab_6">
                                                                         <div class="portlet box red">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-ticket"></i>Remedy Tickets</div>
                                                        <ul class="nav nav-tabs">
                                                            <li id="tab_recentincidents" runat="server">
                                                                <a href="#portlet_tab2_2" data-toggle="tab"> Incidents </a>
                                                            </li>
                                                            <li id="tab_recentchanges" class="active" runat="server">
                                                                <a href="#portlet_tab2_1" data-toggle="tab"> Changes </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="portlet-body">
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="portlet_tab2_1">
                                                                <asp:PlaceHolder ID = "table_recentchanges" runat="server" />
                                                            </div>
                                                            <div class="tab-pane" id="portlet_tab2_2">
                                                                <asp:PlaceHolder ID = "table_recentincidents" runat="server" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
